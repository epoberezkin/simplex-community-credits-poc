...
| **Dust floor** (`destValue ≥ MIN`) — caps spam amplification & leaf use; interim, subsumed by the per-assign fee ([#4](https://github.com/epoberezkin/simplex-community-credits-poc/issues/4)) | T6 (capacity), T7| **Planned** [#3](https://github.com/epoberezkin/simplex-community-credits-poc/issues/3)                                                                        |
